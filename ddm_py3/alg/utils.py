...
def plot(filename, vcl, rand_vcl, kcen_vcl, uncertainty_vcl):
    ...
    plt.plot(np.arange(len(uncertainty_vcl))+1, uncertainty_vcl, label='VCL + Uncertainty-based Coreset', marker='o', color='black')
